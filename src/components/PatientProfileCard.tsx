...
export default function PatientProfileCard() {
	return (
		<div className='bg-white p-4 rounded shadow text-center max-w-sm w-full mx-auto sm:max-w-md lg:max-w-lg'>
			<img className='mx-auto h-24 w-24 rounded-full object-cover' src='https://randomuser.me/api/portraits/women/2.jpg' alt='Patient' />
			<h3 className='mt-2 text-lg font-semibold'>Jessica Silva</h3>
			<p className='text-gray-500 text-sm'>Feminino, 36</p>
			<div className='mt-4 space-y-2 text-sm text-gray-600'>
				<p>📅 Idade: Agosto 23, 1980</p>
